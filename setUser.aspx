<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="setUser.aspx.cs" Inherits="PracticemakesPerfect.index" %>
...
<body>
    ...
    <div>
         ...
         <asp:Button ID ="submitButton" runat="server" Text="Submit"  Onclick="btn1_Click"/>
